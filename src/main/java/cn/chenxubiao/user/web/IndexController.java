...
public class IndexController extends GuestBaseController {
    ...
    @RequestMapping(value = "sys/init", method = RequestMethod.GET)
    public String sysInit(Map<String, Object> map, HttpServletRequest request, Pageable pageable, RegisterBean registerBean) {

        String email = "bbs@bbs.cn";
        String userName = "bbs";
        String password = "bbs_password";
        String code = "abcde";
        ...
        if (userInfo == null) {
            ...
            userRegisterController.regester(request, pageable, registerBean);
            ...
            System.out.println("sys init success");
        }
